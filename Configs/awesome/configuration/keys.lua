...
awful_keyboard.append_global_keybindings({
  awful_key({ modkey }, "F1", hotkeys_popup.show_help, {
    description = "show help",
    group = "awesome",
  }),
  awful_key({ modkey, ctrl }, "r", awesome.restart, {
    description = "reload awesome",
    group = "awesome",
  }),
  awful_key({ modkey, ctrl }, "q", awesome.quit, {
    description = "quit awesome",
    group = "awesome",
  }),
  awful_key({ ctrl, alt }, "l", function()
    lock_screen_show()
  end, {
    description = "lock screen",
    group = "awesome",
  }),
  awful_key({}, "XF86PowerOff", function()
    awesome.emit_signal("exit_screen::show")
  end, {
    description = "exit screen",
    group = "awesome",
  }),
  awful_key({}, "XF86Sleep", lock_screen_show),
  awful_key({ modkey }, "n", function()
    awesome.emit_signal("notification_center::toggle")
  end, {
    description = "toggle notif center",
    group = "awesome",
  }),
  awful_key({ modkey, shift }, "x", function()
  ...
  awful_key({ modkey }, "x", function()
    spawn("powermenu")
  end, {
    description = "powermenu",
    group = "MyLauncher",
  }),
  awful_key({ alt }, "F1", function()
    spawn("launcher")
  end, {
...
-- Launcher
awful_keyboard.append_global_keybindings({
  awful_key({ modkey }, "Return", function()
    spawn("alacritty")
  end, {
    description = "open terminal",
    group = "launcher",
  }),
  awful_key({ modkey }, "s", function()
  ...
  awful_key({ modkey }, "a", function()
    awesome.emit_signal("control_center::toggle")
  end, {
    description = "toggle control center",
    group = "launcher",
  }),
  awful_key({ modkey }, "e", function()
    spawn("pcmanfm")
  end, {
    description = "open file manager",
    group = "launcher",
  }),
  awful_key({ modkey }, "c", function()
  ...
  awful_key({ modkey }, "v", function()
    spawn.with_shell("alacritty -e dooit")
  end, {
    description = "open diodon",
    group = "launcher",
  }),
  awful_key({ modkey, shift }, "c", function(c)
...
awful_keyboard.append_global_keybindings({
  ...
  awful_key({ modkey }, "h", function()
    awful.client.focus.bydirection("left")
  end, {
    description = "focus left client",
    group = "client",
  }),
  awful_key({ modkey }, "j", function()
    awful.client.focus.bydirection("down")
  end, {
    description = "focus down client",
    group = "client",
  }),
  awful_key({ modkey }, "k", function()
    awful.client.focus.bydirection("up")
  end, {
    description = "focus up client",
    group = "client",
  }),
  awful_key({ modkey }, "l", function()
    awful.client.focus.bydirection("right")
  end, {
    description = "focus right client",
    group = "client",
  }),
  awful_key({ modkey, "Shift" }, "j", function()
    awful.client.swap.byidx(1)
  end, {
    description = "swap with next client",
    group = "client",
  }),
  awful_key({ modkey, "Shift" }, "k", function()
    awful.client.swap.byidx(-1)
  end, {
    description = "swap with previous client",
    group = "client",
  }),
  awful_key({ modkey }, "u", awful.client.urgent.jumpto, {
    description = "jump to urgent client",
    group = "client",
  }),
  awful_key({ alt }, "Tab", function()
...
awful_keyboard.append_global_keybindings({
  -- Brightness Control
  awful_key({}, "XF86MonBrightnessUp", function()
    system_controls.brightness_control("increase")
  end, {
    description = "increase brightness",
    group = "hotkeys",
  }),
  awful_key({}, "XF86MonBrightnessDown", function()
    system_controls.brightness_control("decrease")
  end, {
    description = "decrease brightness",
    group = "hotkeys",
  }), -- Volume control
  awful_key({}, "XF86AudioRaiseVolume", function()
    system_controls.volume_control("increase", 5)
  end, {
    description = "increase volume",
    group = "hotkeys",
  }),
  awful_key({}, "XF86AudioLowerVolume", function()
    system_controls.volume_control("decrease", 5)
  end, {
    description = "decrease volume",
    group = "hotkeys",
  }),
  awful_key({}, "XF86AudioMute", function()
    system_controls.volume_control("mute")
  end, {
    description = "mute volume",
    group = "hotkeys",
  }),
  awful_key({}, "XF86AudioMicMute", function()
    system_controls.mic_toggle()
  end, {
    description = "mute microphone",
    group = "hotkeys",
  }), -- Music
  awful_key({}, "XF86AudioPlay", function()
    playerctl:play_pause()
  end, {
    description = "toggle music",
    group = "hotkeys",
  }),
  awful_key({}, "Insert", function()
    playerctl:play_pause()
  end, {
    description = "toggle music",
    group = "hotkeys",
  }),
  awful_key({}, "XF86AudioPrev", function()
    playerctl:previous()
  end, {
    description = "previous music",
    group = "hotkeys",
  }),
  awful_key({}, "XF86AudioNext", function()
    playerctl:next()
  end, {
...
-- Screenshots
awful_keyboard.append_global_keybindings({
  awful_key({}, "Print", function()
    spawn.with_shell("takeshot --area")
  end, {
    description = "take an area screenshot",
    group = "screenshots",
  }),
  awful_key({ modkey, shift }, "s", function()
    spawn.with_shell("takeshot --win")
  end, {
    description = "take an window screenshot",
    group = "screenshots",
  }),
  awful_key({ alt }, "Print", function()
    spawn.with_shell("takeshot --now")
  end, {
...
-- Asusctl
awful_keyboard.append_global_keybindings({
  awful_key({}, "XF86KbdBrightnessUp", function()
    spawn("asusctl -n")
  end, {
    description = "increase keyboard brightness",
    group = "hotkeys (asusctl)",
  }),
  awful_key({}, "XF86KbdBrightnessDown", function()
    spawn("asusctl -p")
  end, {
    description = "decrease keyboard brightness",
    group = "hotkeys (asusctl)",
  }),
  awful_key({}, "XF86Launch4", function()
...
-- Layout
awful_keyboard.append_global_keybindings({
  awful_key({ modkey, ctrl }, "k", function()
    awful.tag.incmwfact(0.05)
  end, {
    description = "increase master width factor",
    group = "layout",
  }),
  awful_key({ modkey, ctrl }, "j", function()
    awful.tag.incmwfact(-0.05)
  end, {
    description = "decrease master width factor",
    group = "layout",
  }),
  awful_key({ modkey, "Shift" }, "h", function()
    awful.tag.incnmaster(1, nil, true)
  end, {
    description = "increase #master clients",
    group = "layout",
  }),
  awful_key({ modkey, "Shift" }, "l", function()
    awful.tag.incnmaster(-1, nil, true)
  end, {
    description = "decrease #master clients",
    group = "layout",
  }),
  awful_key({ modkey, "Control" }, "l", function()
    awful.tag.incncol(1, nil, true)
  end, {
    description = "increase #columns",
    group = "layout",
  }),
  awful_key({ modkey, "Control" }, "h", function()
    awful.tag.incncol(-1, nil, true)
  end, {
    description = "decrease #columns",
    group = "layout",
  }),
  awful_key({ modkey }, "space", function() end, {
    description = "select next layout",
    group = "layout",
  }),
  awful_key({ modkey, "Shift" }, "space", function() end, {
    description = "select previous layout",
    group = "layout",
  }), --
  awful_key({ modkey, shift }, "m", function()
    awful.layout.set(awful.layout.suit.max)
  end, {
    description = "set max layout",
    group = "layout",
  }),
  awful_key({ modkey, shift }, "t", function()
    awful.layout.set(awful.layout.suit.tile)
  end, {
    description = "set tile layout",
    group = "layout",
  }),
  awful_key({ modkey, shift }, "f", function()
...
client.connect_signal("request::default_keybindings", function()
  awful_keyboard.append_client_keybindings({
    awful_key({ modkey, ctrl }, "Up", function(c)
    ...
    awful_key({ modkey }, "f", awful.client.floating.toggle, {
      description = "toggle floating",
      group = "client",
    }),
    awful_key({ modkey, ctrl }, "Down", function(c)
      ...
      function(c)
        ...
        helpers.single_double_tap(nil, function()
          ...
          helpers.float_and_resize(
            c,
            focused_screen_geometry.width * 0.45,
    ...
    awful_key({ modkey, shift }, "Return", function(c)
      c:swap(awful.client.getmaster())
    end, {
      description = "move to master",
      group = "client",
    }),
    awful_key({ ctrl, shift, modkey }, "[", function(_)
      local screen = awful.screen.focused()
    ...
    awful_key({ modkey, shift }, "]", function(c)
      local screen = awful.screen.focused()
...
-- Tags
awful_keyboard.append_global_keybindings({
  awful_key({ modkey }, ";", awful.tag.viewprev, {
    description = "view previous tag",
    group = "tag",
  }),
  awful_key({ modkey }, "'", awful.tag.viewnext, {
    description = "view next tag",
    group = "tag",
  }),
  awful_key({ modkey }, "Escape", awful.tag.history.restore, {
