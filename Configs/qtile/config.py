...
## Layouts ------------------------------
var_bg_color = "#000000"
var_active_bg_color = "#bd93f9"
var_active_fg_color = "#8be9fd"
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.Image(
                    filename="~/.config/qtile/Icons/apple-logo.png",
                    margin=0,
                    background="#fffffa",
                    opacity=0.8,
                ...
                widget.GroupBox(
                    ...
                    active="#f00f0f",
                    block_highlight_text_color="#25fa25",
                    highlight_color="#25faaf",
                    inactive="#000000",
                    foreground="#faaf52",
                    background="#f1f3f4",
                    this_current_screen_border="#000000",
                    this_screen_border="#afafaf",
                ...
                widget.Image(
                    filename="~/.config/qtile/Icons/layout-dashboard.png",
                    margin=2,
                    background="#fffffa",
                ),
                ...
                widget.Image(
                    filename="~/.config/qtile/Icons/folder-search.png",
                    margin=2,
                    background="#fffffa",
                    mouse_callbacks={"Button1": search},
                ),
                widget.Image(
                    filename="~/.config/qtile/Icons/folder-home.png",
                    margin=2,
                    background="#fffffa",
                    mouse_callbacks={"Button1": ranger},
                ),
                widget.Image(
                    filename="~/.config/qtile/Icons/upload-thick-box.png",
                    margin=2,
                    background="#fffffa",
                ...
                widget.Image(
                    background="#fffffa",
                    filename="~/.config/qtile/Icons/ab-testing-browsers.png",
                    margin=2,
                ),
                widget.WindowName(
                    background="#fffffa",
                ...
                widget.Image(
                    filename="~/.config/qtile/Icons/study-brain.png",
                    margin=2,
                    background="#fffffa",
                ),
                widget.Pomodoro(
                ...
                widget.Image(
                    filename="~/.config/qtile/Icons/music-genre-smoke.png",
                    margin=2,
                    background="#fffffa",
                ),
                widget.Mpd2(
                ...
                widget.Image(
                    filename="~/.config/qtile/Icons/time-clock-circle.png",
                    background="#fffffa",
                    margin_y=3,
                    margin_x=3,
                ),
                ...
                widget.Image(
                    filename="~/.config/qtile/Icons/logout-1.png",
                    margin=2,
                    background="#fffffa",
...
floating_layout = layout.Floating(
    ...
    float_rules=[
        ...
        *layout.Floating.default_float_rules,
        Match(wm_class="Figure|Matplotlib|python|matplotlib"),
        Match(wm_class="Lxappearance|Feh"),
        ...
        Match(wm_class="Fsearch|fsearch"),
