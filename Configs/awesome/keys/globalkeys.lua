...
modkey = "Mod4"
altkey = "Mod1"
--local mymainmenu = require('layout/menu/.mainmenu')
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey, "Shift" }, "q", function()
		os.execute("powermenu")
	end --[[awesome.quit]], { description = "quit awesome", group = "awesome" }),
	...
	end, { description = "Open Launcher", group = "client" }),
	...
	awful.key({}, "Print", function()
		awful.spawn.with_shell("takeshot --area")
