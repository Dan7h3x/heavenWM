...
os.execute("feh --bg-fill -z  ~/.config/awesome/wall")
...
awful.spawn.with_shell("dunst --config ~/.config/dunst/dunstrc")
awful.spawn.with_shell("setxkbmap us,ir -option 'grp:alt_shift_toggle'")
