...
local PATH_TO_ICONS = "/home/mehdi/.config/awesome/icons"
local PAUSE_ICON_NAME = PATH_TO_ICONS .. "/play.png"
local PLAY_ICON_NAME = PATH_TO_ICONS .. "/pause-button.png"
local STOP_ICON_NAME = PATH_TO_ICONS .. "/ghost.png"
